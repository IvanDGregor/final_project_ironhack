...
export class CountryReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_country/count_lead`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
        ...
        results.forEach((result) => {
          countries.push(result[0]);
          leadCount.push(result[1]);
        });
        this.updateTable(leadChart, countries, leadCount);
      });
  ...
  public updateTable(chart, countries, leadByCountry) {
    chart.data.labels = countries;
    chart.data.datasets[0].data = leadByCountry;
    chart.update();
  }
  ...
  public retrieveOpen() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_country/count_open_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
        ...
        this.updateTable(this.opportunityChart, countries, opportunityCount);
      });
  }
  ...
  public retrieveClosedWon() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_country/count_closed_won_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
  ...
  public retrieveClosedLost() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_country/count_closed_lost_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
  ...
  public retrieveAll() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_country/count_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
