...
export class ProductReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_product/count_lead`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
  ...
  public retrieveOpen() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_product/count_open_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
  ...
  public retrieveClosedWon() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_product/count_closed_won_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
  ...
  public retrieveClosedLost() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_product/count_closed_lost_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
  ...
  public retrieveAll() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_product/count_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
