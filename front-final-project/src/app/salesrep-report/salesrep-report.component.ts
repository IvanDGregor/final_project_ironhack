...
@Component({
  selector: 'app-salesrep-report',
  templateUrl: './salesrep-report.component.html',
  styleUrls: ['./salesrep-report.component.scss'],
})
export class SalesrepReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http
      .get<any>(
        `${environment.apiUrl}/report/leads-by-salesrep`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
        ...
        results.forEach((result) => {
          salesreps.push(result[0]);
          leadCount.push(result[1]);
        });
        this.updateTable(leadChart, salesreps, leadCount);
      });
  ...
  public retrieveOpen() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_salesrep/count_open_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
        ...
        this.updateTable(this.opportunityChart, salesreps, opportunityCount);
      });
  }
  ...
  public retrieveClosedWon() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_salesrep/count_closed_won_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
  ...
  public retrieveClosedLost() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_salesrep/count_closed_lost_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
  ...
  public retrieveAll() {
    this.http
      .get<any>(
        `${environment.apiUrl}/opportunities/by_salesrep/count_opportunity`,
        this.httpOptions
      )
      .subscribe((results) => {
        console.log(results);
